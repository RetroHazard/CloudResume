        ...
        >
            <div className='mx-auto flex h-12 max-w-6xl items-center justify-between px-4'>
                <div className='flex items-center gap-2.5'>
                    ...
                    <span className='font-heading text-sm font-bold tracking-[0.2em] text-content-header uppercase'>
                        Cloud&nbsp;Line
                    </span>
                    <span className='ml-1 hidden font-mono text-[0.6rem] tracking-[0.18em] text-content-accent uppercase sm:inline'>
                        · Network Résumé
                    </span>
                </div>
                <div className='flex items-center gap-4'>
                    ...
                    <span
                        ...
                        className={`flex items-center gap-1.5 font-mono text-[0.6rem] font-semibold tracking-[0.14em] uppercase max-sm:hidden ${styles.text}`}
                    >
