...
export function RadarLabels({ offset = 24, fontSize = 11, interactive = false, className = '' }: RadarLabelsProps) {
            ...
            {metrics.map((metric, i) => {
                ...
                return (
                    ...
                    >
                        <text
                            className={
                                interactive ? 'cursor-pointer transition-opacity duration-150 hover:opacity-100' : ''
                            }
