        ...
        <>
            ...
            >
                <div className='flex flex-col items-center gap-5 py-8 text-center'>
                    <p className='font-heading text-7xl font-extrabold tracking-wide text-alert sm:text-8xl'>404</p>
                    <div className='w-full max-w-md rounded border border-dashed border-alert/40 bg-alert/5 px-4 py-3 font-mono text-xs text-content-accent'>
                        <p className='mb-1 tracking-[0.18em] text-alert uppercase'>⚠ No Service</p>
                        <p className='tabular mb-0'>
                            Line <span className='text-content-subtitle'>{path}</span> does not stop at this station.
                        </p>
                    </div>
                    <Link to='/' className='ticket-button'>
