                    ...
                    <div className="content-block" id="profile">
                        <div className="flex flex-col gap-6 items-start sm:flex-row">
                            <div className="flex items-center gap-4 sm:flex-col">
                                <img className="rounded-lg h-24 max-w-none md:h-52 md:w-52 sm:h-36 sm:w-36 w-24"
                                     src={personalData.profilePicture} alt="Headshot"/>
                                    ...
                                    <button
                                        ...
                                        <div className="icon-box">
                                            <i className="w-5 h-5 mr-2 text-content-icons">
                                                <iconify-icon inline="" className="mb-1 icon-box"
                            ...
                            <div className="flex flex-col w-full gap-5">
                                ...
                                <div className="flex flex-col gap-6">
                                    ...
                                    <div
                                        className="flex flex-col gap-4"> {/* TODO: Write Function to Automatically Retrieve Content from File(?) */}
                                        <p className="leading-relaxed mb-0 text-sm sm:text-base sm:leading-relaxed">
                                            ...
                                            sodales ac dui
                                            at <em>vestibulum</em>. In condimentum metus id dui tincidunt, in blandit mi <a
                                            href=".">vehicula</a>. Nulla lacinia, erat sit amet elementum vulputate, lectus
                                            mauris volutpat mi, vitae accumsan metus elit ut nunc. Vestibulum lacinia enim
                                            eget eros fermentum scelerisque. Proin augue leo, posuere ut imperdiet vitae,
                                            fermentum eu ipsum. Sed sed neque sagittis, posuere urna nec, commodo leo.
                                            Pellentesque posuere justo vitae massa volutpat maximus.
                                        </p>
                                        <p className="leading-relaxed mb-0 text-sm sm:text-base sm:leading-relaxed">
                                            Lorem ipsum dolor sit amet, consectetur <strong>adipiscing elit</strong>. In
                                            sodales ac dui at <em>vestibulum</em>. In condimentum metus id dui tincidunt, in
                                            blandit mi <a href="/public">vehicula</a>. Nulla lacinia, erat sit amet
                                            elementum vulputate, lectus mauris volutpat mi, vitae accumsan metus elit ut
                                            nunc. Vestibulum lacinia enim eget eros fermentum scelerisque. Proin augue leo,
                                            posuere ut imperdiet vitae, fermentum eu ipsum. Sed sed neque sagittis, posuere
                                            urna nec, commodo leo. Pellentesque posuere justo vitae massa volutpat maximus.
                                        </p>
