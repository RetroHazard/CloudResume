...
const ExperienceItem = ({ company, job_title, location, type, start, end, logo, website, details, technologies }) => {
    return (
        <div className="flex flex-col gap-3">
            <div className="flex gap-2 justify-between w-full">
                <div className="flex gap-4">
                    <img className="hidden rounded-xl sm:block h-[6.5rem] w-[6.5rem]" src={logo} alt={`${company} logo`} />
