...
resource "aws_cloudfront_distribution" "tfer--E37NSQHT5FF2XS" {
  ...
  default_cache_behavior {
    ...
    function_association {
      ...
      function_arn = "arn:aws:cloudfront::339712851438:function/StagingAuthorization"
    }
  ...
  viewer_certificate {
    acm_certificate_arn            = "arn:aws:acm:us-east-1:339712851438:certificate/d2c204b7-bb92-437a-b2d8-a9dcd55aea97"
