...
output "aws_route53_zone_crc-Z03405071SXF625TZSK71_cloudresume-agb-002E-jp_id" {
  value = aws_route53_zone.crc-Z03405071SXF625TZSK71_cloudresume-agb-002E-jp.id
}
